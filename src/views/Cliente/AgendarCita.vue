...
const agendarCita = async () => {
 ...
 // Validar si la descripción tiene al menos 3 palabras
 const wordCount = problemDetails.value.trim().split(/\s+/).length;
  if (wordCount < 3) {
    showSnackbar('La descripción debe contener al menos 3 palabras', 'error');
    return;
  }
