    ...
    <v-content>
      <v-container>
        ...
        <v-row justify="center" align="center">
          ...
          <v-col cols="12" md="6" class="text-center" style="padding-left: 100px">
            <p class="white-text">NOSOTROS</p>
            <p class="white-text">
              El Mundo Tecnologico, somos tu solución integral para la reparación de todos tus
              electrodomésticos y dispositivos electrónicos. Con un equipo de expertos altamente
              capacitados, ofrecemos servicios de reparación confiable y rápido para una amplia gama
      ...
      <br />
      <v-divider class="border-opacity-100" color="#E8EAF6"></v-divider>
      <br />
      <v-main>
      ...
      <v-row align="center" justify="start">
        <v-col cols="12" md="8" class="text-center">
          <br />
          <v-row
            style="position: absolute; top: 555px; left: 40px; color: aliceblue"
            class="social-icons"
          >
            <v-btn
              icon
          ...
          <h5 class="my-4 white--text">
            ...
            <v-btn
              ...
              >Cerrar Sesion</v-btn
            >
            <b style="position: absolute; top: 610px; left: 40px; color: aliceblue"
              >Telefono:8715265042</b
            >
            <b style="position: absolute; top: 630px; left: 40px; color: aliceblue"
              >MundoElectronicoTRC@gmail.com</b
            >
            ...
            <v-col cols="auto">
              <h4>
                <b style="color: aliceblue"
                  >Calle dia de la fuente No.1463 6 campestre la rosita , Torreón, Mexico</b
                >
              </h4>
            </v-col>
          </v-row>
